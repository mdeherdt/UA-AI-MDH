...
Code: [Link](./tracking.zip)

Extract the code from the zip into this directory and complete the exercises described below.
...
## Q1: DiscreteDistribution Class and Observation Probability (autograder 5)
...
## Q2: Exact Inference Observation (autograder 6)
...
## Q3: Exact Inference with Time Elapse (autograder 7)
...
## Q4: Exact Inference Full Test (autograder 8)
...
## Q5: Approximate Inference Initialization and Beliefs (autograder 9)
...
## Q6: Approximate Inference Observation (autograder 10)
...
## Q7: Approximate Inference with Time Elapse (autograder 11)
